// Source : https://leetcode.com/problems/count-the-repetitions/submissions/
// Author : cornprincess
// Date   : 2020-04-19
 ...
 * You are given two non-empty strings s1 and s2 (each at most 100 characters long) and two integers 0 
 * &le; n1 &le; 106 and 1 &le; n2 &le; 106. Now consider the strings S1 and S2, where S1=[s1,n1] and 
 * S2=[s2,n2]. Find the maximum integer M such that [S2,M] can be obtained from S1.
 * 
 * Example:
 * 
 * Input:
